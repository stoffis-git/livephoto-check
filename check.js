...
export function checkLivePhoto(movBuffer, heicBuffer = null) {
  ...
  // 4. The vitality triad. These are static values in moov/meta, unlike the
  // sensor track checked below - a distinction this library originally got
  // wrong. See the correction in the README.
